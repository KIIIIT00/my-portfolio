...
const LabWebsite: React.FC = () => {
    const projectData = {
        ...
        coverImage: { src: "/assets/images/project/lab_website/lab_website.png", alt: '研究室Webサイト' },
        ...
        galleryImages: [
            { src: "/assets/images/project/lab_website/research.png", alt: '研究紹介' },
            { src: "/assets/images/project/lab_website/team.png", alt: 'チーム' },
            { src: "/assets/images/project/lab_website/news.png", alt: 'ニュース' }
        ]
    };
